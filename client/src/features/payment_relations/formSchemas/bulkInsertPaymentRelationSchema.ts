...
import {
  ...
  BulkInsertPaymentRelationByManagementGroupIdRequestGroup,
  BulkInsertPaymentRelationByManagementGroupIdRequestAffiliationsInner,
} from 'src/openapi-generator';

const GroupSchema: z.ZodType<BulkInsertPaymentRelationByManagementGroupIdRequestGroup> =
  z.object({
    name: z
      .string()
...
const AffiliationSchema: z.ZodType<BulkInsertPaymentRelationByManagementGroupIdRequestAffiliationsInner> =
  z.object({
